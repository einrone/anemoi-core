    ...
    def _build_networks(self, model_config: DotDict) -> None:
        ...
        for encoder_name in self.encoder_names:
            ...
            self.encoder[encoder_name] = instantiate(
                ...
                edge_dim=self.edge_dim[encoder_name],
            )
        ...
        for decoder_name in self.decoder_names:
            for dataset_name in self.decoder_names[decoder_name]:
            ...
            self.decoder[decoder_name] = instantiate(
                ...
                in_channels_dst=self.target_dim[decoder_name],
                hidden_dim=self.num_channels,
                out_channels_dst=self.output_dim[decoder_name],
                edge_dim=self.edge_dim[decoder_name],
            )
    ...
    def forward(
        ...
        **kwargs,
        ...
        for encoder_name in encoder_names:
            dataset_name = self.encoder_names[encoder_name]
        ...
        for decoder_name in decoder_names:
            for dataset_name in self.decoder_names[decoder_name]:
                ...
                # NODE ATTRIBUTES, GRAPH PROVIDER AND SHARDING SHOULD BE INITIALIZED FOR ALL DATASETS
